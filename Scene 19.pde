...
void draw() {
  ...
  pushMatrix();
  scale(2.0);
  boolean mouthOpen = (currentFrame / 8) % 2 == 0; // buka tutup setiap 8 frame (~0.13 detik)
  drawKakek(180, 165, mouthOpen);
  popMatrix();

  saveFrame("frames/frame-####.png");
  currentFrame++;
  if (currentFrame >= totalFrames) noLoop();
}
