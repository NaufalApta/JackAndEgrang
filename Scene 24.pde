...
void draw() {
  ...
  // Posisi Jack bergerak dari kanan ke depan kakek
  float startX = 500;
  float stopX = 360; // stop di depan kakek
  float t = min(1.0, currentFrame / float(totalFrames));  // clamp to 1.0
  float jackX = lerp(startX, stopX, t);
